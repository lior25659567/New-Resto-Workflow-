...
export function Legend({
  ...
  if (kind === "undercut") {
    return (
      <div className="pointer-events-none absolute bottom-4 left-1/2 -translate-x-1/2 rounded-md bg-white/90 px-3 py-2 shadow-md ring-1 ring-[#d1d1d1] backdrop-blur">
        <div className="flex items-center gap-4 text-[11px] text-[#3e3d40]">
  ...
  return (
    <div className="pointer-events-auto absolute bottom-4 left-1/2 -translate-x-1/2 rounded-md bg-white/90 px-3 py-2 shadow-md ring-1 ring-[#d1d1d1] backdrop-blur">
            ...
            <button
              ...
              className={[
                ...
                step === s
                  ...
                  : "bg-white text-[#3e3d40] ring-[#d1d1d1] hover:bg-[#f3f6fa]",
              ].join(" ")}
            >
              {s.toFixed(1)}
            </button>
...
export function Metric({
  ...
  return (
    <div className="flex items-baseline justify-between gap-2">
      <span className="text-[11px] text-[#818181]">{label}</span>
...
export function SizeRow({
  ...
  return (
    <div>
      <div className="mb-1 flex items-center justify-between text-[11px] text-[#3e3d40]">
...
export function SectionPanel({ data }: { data: CrossSectionData[] }) {
  return (
    <div className="flex w-[360px] shrink-0 flex-col gap-3 overflow-y-auto border-l border-[#d1d1d1] bg-[#f4f7fa] p-3">
      <div className="flex items-center gap-2">
        <div className="text-[12px] font-semibold uppercase tracking-wide text-[#3e3d40]">
          Cross-sections
        </div>
        <div className="ml-auto flex items-center gap-3 text-[10.5px] text-[#6b7686]">
          <span className="flex items-center gap-1">
            <span className="inline-block h-[2px] w-4 bg-[#3e3d40]" />
            tx
          </span>
          <span className="flex items-center gap-1">
...
function SectionCard({ data }: { data: CrossSectionData }) {
  ...
  return (
    <div className="rounded-lg border border-[#d1d1d1] bg-white p-2 shadow-sm">
      ...
      <div className="mb-1 flex items-center gap-2 px-1">
        ...
        <input
          ...
          className="flex-1 accent-[#00ADEF]"
        />
      ...
      <div className="mb-1 flex items-center gap-2 px-1">
        ...
        <button
          ...
          className="rounded border border-[#d1d1d1] bg-white px-1.5 py-0.5 text-[9.5px] font-medium text-[#3e3d40] hover:bg-[#f4f7fa]"
